...
The following example shows how to get a web token from ctrlX OSs authentication server. The username and password has to be adapted in the `make header` function.
...
![examples-motion-axes-create.png](./images/examples-motion-axes-create.png)
