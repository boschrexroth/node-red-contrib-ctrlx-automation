...
The following example shows how to enable and disable the kinematic group "Robot". Axis states can be `STANDSTILL` or `COORDINATED_MOTION` after grouping. Axes must be grouped and the kinematic must be enabled prior to physical axis motion.

![example-motion-enable-disable-kinematic.png](./images/example-motion-enable-disable-kinematic.png)
![example-motion-enable-disable-kinematic-dashboard.png](./images/example-motion-enable-disable-kinematic-dashboard.png)

```JSON
[{"id":"343c07da133a2dba","type":"ctrlx-datalayer-request","z":"3a89ede8547cbb8b","device":"7b877229.678964","method":"CREATE","path":"motion/kin/Robot/cmd/group-ena","payloadFormat":"value_type","name":"\"Robot\" enable","x":680,"y":100,"wires":[[]]},{"id":"9f080e5164823d8d","type":"inject","z":"3a89ede8547cbb8b","name":"Manual Trigger","props":[{"p":"payload"}],"repeat":"","crontab":"","once":false,"onceDelay":0.1,"topic":"","payload":"","payloadType":"str","x":200,"y":100,"wires":[["343c07da133a2dba"]]},{"id":"7f52506b8bfcaedb","type":"ctrlx-datalayer-request","z":"3a89ede8547cbb8b","device":"7b877229.678964","method":"CREATE","path":"motion/kin/Robot/cmd/group-dis","payloadFormat":"value_type","name":"\"Robot\" disable","x":680,"y":160,"wires":[[]]},{"id":"dbd40709a3863a5e","type":"comment","z":"3a89ede8547cbb8b","name":"Example: Enable kinematic","info":"","x":190,"y":60,"wires":[]},{"id":"5dec5e2b73611cd2","type":"ui_button","z":"3a89ede8547cbb8b","name":"","group":"85755e14b124f041","order":3,"width":"3","height":"1","passthru":false,"label":"Enable \"Robot\"","tooltip":"","color":"","bgcolor":"","className":"","icon":"","payload":"","payloadType":"str","topic":"topic","topicType":"msg","x":200,"y":140,"wires":[["343c07da133a2dba"]]},{"id":"8c78cfc675f3ab51","type":"inject","z":"3a89ede8547cbb8b","name":"Manual Trigger","props":[{"p":"payload"}],"repeat":"","crontab":"","once":false,"onceDelay":0.1,"topic":"","payload":"","payloadType":"str","x":200,"y":220,"wires":[["7f52506b8bfcaedb"]]},{"id":"068bf6c45f90d2b2","type":"ui_button","z":"3a89ede8547cbb8b","name":"","group":"85755e14b124f041","order":3,"width":"3","height":"1","passthru":false,"label":"Disable \"Robot\"","tooltip":"","color":"","bgcolor":"","className":"","icon":"","payload":"","payloadType":"str","topic":"topic","topicType":"msg","x":200,"y":260,"wires":[["7f52506b8bfcaedb"]]},{"id":"124489bc0c8c389f","type":"comment","z":"3a89ede8547cbb8b","name":"Example: Disable kinematic","info":"","x":180,"y":180,"wires":[]},{"id":"7b877229.678964","type":"ctrlx-config","name":"localhost","hostname":"localhost","debug":false},{"id":"85755e14b124f041","type":"ui_group","name":"Kinematic Handling","tab":"9cba2148.8c9148","order":3,"disp":true,"width":"6","collapse":false,"className":""},{"id":"9cba2148.8c9148","type":"ui_tab","name":"Examples","icon":"dashboard","order":7,"disabled":false,"hidden":false}]
```
